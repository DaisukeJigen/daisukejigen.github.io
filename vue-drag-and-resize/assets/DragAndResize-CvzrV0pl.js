...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    }, size = ref({ x: 0, y: 0 }), sizeAtResizeStart = ref({ x: 0, y: 0 }), thisDiv = computed(() => thisInstance == null ? void 0 : thisInstance.vnode.el), thisInstance = getCurrentInstance();
    ...
    const __returned__ = { borders, boundries, clickedAtPosition, collideBottom, collideLeft, collideRight, collideTop, collisionCheck, corners, cssHeight, cssLeft, cssPosition, cssTop, cssWidth, divPos, divPosAtDragStart, divPosWhenClicked, drag, emit, getParent, inRange, mousePosition, mousePositionInParent, movedX, movedY, parentBorders, parentPosition, parentSize, props, resize, resizedDown, resizedLeft, resizedRight, resizedUp, resizeMode, resizeModeWhenClicked, selected, setBoundries, setParentInfo, size, sizeAtResizeStart, thisDiv, thisInstance };
